...
{
	$('#pratinha_ativo').css('bottom','0px');
	$('.Texto_1').css('bottom','47px');
}
...
$('#pratinha_next').click(function(){
	...
	{	
		...
		window.setTimeout(function(){ window.location="../2_Avaliacao_Inicial_pt1/index.html"; },1000);
	}
});
