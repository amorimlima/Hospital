	...
	behinstProto.init = function ()
	{
		...
		case 1:		// size
			...
			if (!this.reverse) {
				...
				this.targetX = this.initialX * 1/tx;
				this.targetY = this.initialY * 1/ty;
			}
			this.tweenInitialX = this.initialX;
			this.tweenInitialY = this.initialY;
			if (this.coord_mode == 1) {
				this.tweenTargetX = this.tweenInitialX * this.targetX / this.initialX;
				this.tweenTargetY = this.tweenInitialY * this.targetY / this.initialY;
			} else {
				this.tweenTargetX = this.initialX * (1/ix) * tx;
				this.tweenTargetY = this.initialY * (1/iy) * ty;
			}
			if (this.playmode == -6) {
		...
		case 2:		// width
			if (this.initial == "current") this.initial = "1,1";
			if (this.initial.indexOf(',') == -1) {
				var ix = parseFloat(this.initial);
			} else {
				var ix = parseFloat(this.initial.split(",")[0]);
			}
			if (this.target.indexOf(',') == -1)  {
				var tx = parseFloat(this.target);
			} else {
				var tx = parseFloat(this.target.split(",")[0]);
			}
			if (this.initial != "current") {
		...
		case 3:		// height
			...
			if (this.initial.indexOf(',') == -1) {
				...
				var ix = parseFloat(this.initial.split(",")[1]);
			}
			if (this.target.indexOf(',') == -1)  {
				var tx = parseFloat(this.target);
			} else {
				var tx = parseFloat(this.target.split(",")[1]);
			}
			if (this.initial != "current") {
				if (!this.reverse) {
					if (this.playmode != 1) { //if repeat, don't initialize
						this.inst.height = this.tweenSaveHeight * ix;
					}
				}
			}
			if (this.loop) {
			...
			this.initialX = this.inst.height;
			if (!this.reverse) {
				this.targetX = this.initialX * tx;
			} else {
				this.targetX = this.initialX * 1/tx;
			...
			if (this.playmode == -6) {
				this.tweenTargetX = this.tweenSaveHeight * ix;
			}
			break;
		case 4:		// angle
			if (this.initial != "current") {
		...
		case 7:		// size pixel
			...
			this.doTweenX = false;
			if (parseFloat(this.target.split(",")[0]) != 0)
				this.doTweenX = true;
			this.doTweenY = false;
			if (parseFloat(this.target.split(",")[1]) != 0)
				this.doTweenY = true;
			this.tweenInitialX = this.initialX;
			this.tweenInitialY = this.initialY;
			this.tweenTargetX = this.targetX;
...
;
	...
	behinstProto.tick = function ()
	{
		...
		if (this.i >= this.initiating + this.duration) {
			if (this.onEnd == false) {
				this.onEnd = true;
		...
		if (this.i <= (this.duration + this.initiating)) {
			...
			case 2:		// width
				...
				break;
			case 3:		// height
				if (this.inst.height !== this.lastKnownX)
					this.tweenInitialX = this.inst.height;
				this.inst.height = this.tweenInitialX + (this.tweenTargetX - this.tweenInitialX) * factor;
				this.lastKnownX = this.inst.height;
				break;
			case 4:		// angle
	...
	behinstProto.doEndFrame = function (isForceStop)
	{
		...
		case 2:		// width
			...
			break;
		case 3:		// height
			this.inst.height = this.tweenTargetX;
			break;
		case 4:		// angle
...
,	[
	...
	[
		...
		[
			...
			5234212716551589,
			[
				["images/bg-sheet0.png", 376936, 0, 0, 1024, 768, 1, 0.5, 0.5,[],[],0]
			]
			]
		],
		[
...
,	[
		...
		[
			...
			4958308644842011,
			[
				["images/ajuda-sheet0.png", 12595, 0, 0, 441, 199, 1, 0.478458046913147, 0.5477386713027954,[],[0.3764209747314453,-0.5477386713027954,0.521541953086853,-0.5477386713027954,0.521541953086853,-0.2211076617240906,0.3764209747314453,-0.2211076617240906],0]
			]
			]
		],
		[
...
,	[
		...
		[
			...
				["images/places-sheet1.png", 362, 266, 1, 126, 122, 1, -0.420634925365448, -1.032786846160889,[],[0.7857139110565186,1.163933873176575,1.34920597076416,1.303277850151062,1.214285850524902,1.942622900009155,0.5,1.852458834648132,0.6825399398803711,1.508195877075195],3],
				["images/places-sheet1.png", 362, 131, 128, 119, 123, 1, -1.26890754699707, -1.130081295967102,[],[1.487394571304321,1.276422262191773,2.142857551574707,1.308942317962647,2.084033489227295,1.999999284744263,1.319327712059021,1.943089246749878],3],
				["images/places-sheet2.png", 169, 1, 1, 97, 115, 1, -2.494845390319824, -1.252173900604248,[],[2.701031446456909,1.391305923461914,3.422680377960205,1.391303896903992,3.381443500518799,2.121738910675049,2.618556499481201,2.139132022857666],3],
				["images/places-sheet1.png", 362, 1, 384, 108, 107, 1, -3, -1.383177518844605,[],[3.15740704536438,1.822428464889526,3.120369911193848,1.490653514862061,3.953703880310059,1.523363471031189,3.898148059844971,2.261682510375977,3.046296358108521,2.261682510375977],3]
			]
			]
		],
		[
...
,		[
			...
			[
			[
				[137, 646, 0, 125, 119, 0, 0, 1, 0, 0, 0, 0, []],
				13,
				1,
				[
				],
...
,			[
				[852, 384, 0, 250, 100, 0, 0, 1, -0.871999979019165, -2.650000095367432, 0, 0, []],
				14,
				5,
				[
				],
...
,			[
				[852, 384, 0, 73, 74, 0, 0, 1, -3.16438364982605, -3.756756782531738, 0, 0, []],
				15,
				6,
				[
				],
...
,			[
				[512, 384, 0, 127, 147, 0, 0, 1, 2.866141796112061, -1.040816307067871, 0, 0, []],
				17,
				9,
				[
				],
...
,			[
				[512, 384, 0, 148, 136, 0, 0, 1, 2.243243217468262, -0.5073529481887817, 0, 0, []],
				17,
				10,
				[
				],
...
,			[
				[512, 384, 0, 115, 127, 0, 0, 1, 2.617391347885132, 0.110236220061779, 0, 0, []],
				17,
				11,
				[
				],
...
,			[
				[512, 384, 0, 155, 119, 0, 0, 1, 2.329032182693481, 0.6722689270973206, 0, 0, []],
				17,
				12,
				[
				],
...
,			[
				[512, 384, 0, 126, 120, 0, 0, 1, 2.960317373275757, 1.350000023841858, 0, 0, []],
				17,
				13,
				[
				],
...
,			[
				[512, 384, 0, 128, 110, 0, 0, 1, 2.8125, 2.018181800842285, 0, 0, []],
				17,
				14,
				[
				],
...
,			[
				[512, 384, 0, 107, 122, 0, 0, 1, 2.794392585754395, 2.122950792312622, 0, 0, []],
				17,
				15,
				[
				],
...
,			[
				[512, 384, 0, 103, 115, 0, 0, 1, 2.233009815216065, 2.373913049697876, 0, 0, []],
				17,
				20,
				[
				],
...
,			[
				[512, 384, 0, 100, 111, 0, 0, 1, 1.610000014305115, 2.531531572341919, 0, 0, []],
				17,
				25,
				[
				],
...
,			[
				[512, 384, 0, 104, 105, 0, 0, 1, 0.807692289352417, 2.704761981964111, 0, 0, []],
				17,
				26,
				[
				],
...
,			[
				[512, 384, 0, 126, 113, 0, 0, 1, 0.02380952425301075, 2.47787618637085, 0, 0, []],
				17,
				27,
				[
				],
...
,			[
				[512, 384, 0, 130, 125, 0, 0, 1, -0.6615384817123413, 2.144000053405762, 0, 0, []],
				17,
				28,
				[
				],
...
,			[
				[512, 384, 0, 164, 119, 0, 0, 1, -0.9207317233085632, 1.966386556625366, 0, 0, []],
				17,
				30,
				[
				],
...
,			[
				[512, 384, 0, 162, 130, 0, 0, 1, -1.376543164253235, 1.423076868057251, 0, 0, []],
				17,
				31,
				[
				],
...
,			[
				[512, 384, 0, 108, 135, 0, 0, 1, -2.675925970077515, 0.7037037014961243, 0, 0, []],
				17,
				32,
				[
				],
...
,			[
				[512, 384, 0, 135, 124, 0, 0, 1, -1.770370364189148, 0.2903225719928742, 0, 0, []],
				17,
				33,
				[
				],
...
,			[
				[512, 384, 0, 117, 130, 0, 0, 1, -1.290598273277283, 0.3076923191547394, 0, 0, []],
				17,
				34,
				[
				],
...
,			[
				[512, 384, 0, 126, 137, 0, 0, 1, -0.6746031641960144, 0.6350364685058594, 0, 0, []],
				17,
				35,
				[
				],
...
,			[
				[512, 384, 0, 120, 158, 0, 0, 1, -0.2416666597127914, 0.9683544039726257, 0, 0, []],
				17,
				36,
				[
				],
...
,			[
				[512, 384, 0, 122, 112, 0, 0, 1, 0.5327869057655335, 1.473214268684387, 0, 0, []],
				17,
				37,
				[
				],
...
,			[
				[512, 384, 0, 135, 133, 0, 0, 1, 1.177777767181397, 1.270676732063294, 0, 0, []],
				17,
				38,
				[
				],
...
,			[
				[512, 384, 0, 109, 110, 0, 0, 1, 1.73394501209259, 0.9454545378684998, 0, 0, []],
				17,
				39,
				[
				],
...
,			[
				[512, 384, 0, 113, 110, 0, 0, 1, 1.646017670631409, 0.1727272719144821, 0, 0, []],
				17,
				40,
				[
				],
...
,			[
				[512, 384, 0, 128, 117, 0, 0, 1, 1.28125, -0.3418803513050079, 0, 0, []],
				17,
				41,
				[
				],
...
,			[
				[512, 384, 0, 131, 125, 0, 0, 1, 0.8549618124961853, -0.6639999747276306, 0, 0, []],
				17,
				42,
				[
				],
...
,			[
				[512, 384, 0, 130, 116, 0, 0, 1, 0.2153846174478531, -0.9913793206214905, 0, 0, []],
				17,
				43,
				[
				],
...
,			[
				[512, 384, 0, 126, 122, 0, 0, 1, -0.420634925365448, -1.032786846160889, 0, 0, []],
				17,
				44,
				[
				],
...
,			[
				[512, 384, 0, 119, 123, 0, 0, 1, -1.26890754699707, -1.130081295967102, 0, 0, []],
				17,
				45,
				[
				],
...
,			[
				[512, 384, 0, 97, 115, 0, 0, 1, -2.494845390319824, -1.252173900604248, 0, 0, []],
				17,
				46,
				[
				],
...
,			[
				[512, 384, 0, 108, 107, 0, 0, 1, -3, -1.383177518844605, 0, 0, []],
				17,
				47,
				[
				],
...
,			[
				[512, 768, 0, 431, 84, 0, 0, 1, 0.4222737848758698, -2.452380895614624, 0, 0, []],
				12,
				16,
				[
				],
...
,		[
			...
			0,
			-1,
false,false,2005264745767008,false
		]
,		[
			1,
			"clicked",
			0,
			0,
false,false,6214423516330124,false
		]
,		[
			1,
			"proximaCasa",
			0,
			0,
false,false,3962648043564663,false
		]
,		[
			1,
			"PlayerPodeJogar",
			0,
			0,
false,false,5856097205988835,false
		]
,		[
			1,
			"gamestate",
...
,			[
				...
				[
					...
					[
						2,
						"../10_Pratinha_desperdicio/index.html"
					]
				]
,				[
					3,
