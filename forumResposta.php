...
<html lang="pt-br">
    ...
    <body>
        <input type="hidden" id="idfrq" value="<?php echo $_GET["resp"]; ?>"/>
        <input type="hidden" id="frrQtde" value ="<?php echo $respostasController->totalByQuestao($_GET["resp"]); ?>"/>
        <!--Conteudo Geral-->
        <div id="container">
            <!--Topo-->
            <div class="row">
                <?php $templateGeral->topoSite(); ?>      
            </div>
            <!--Conteudo Central-->
                        ...
                        <div class="col-xs-12 col-md-8 col-lg-8">               
                            <div id="Conteudo_Area_box_left" >
                                <div class="conteudoRespostas">
                                    <?php $templateResposta->getQuestao($_GET['resp']); ?>
                                </div>
                            </div>
                        </div>
        ...
        <div id="respostaErroVazia" class='modalMensagem' style="display:none">
            <?php $templateGeral->mensagemRetorno('forum', 'Resposta Inválida!', 'erro'); ?>
        </div>
        <div id="respostaErroInesperado" class='modalMensagem' style="display:none">
            <?php $templateGeral->mensagemRetorno('forum', 'Houve um erro inesperado. tente mais tarde!', 'erro'); ?>
        </div>
        <div id="respostaSucesso" class='modalMensagem' style="display:none">
            <?php $templateGeral->mensagemRetorno('forum', 'Respondido com sucesso!', 'sucesso'); ?>
        </div>
