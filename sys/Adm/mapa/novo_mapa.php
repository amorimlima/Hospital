...
<body id="adm">
	...
	<div id="corpo">
 		<form action="doAddMapaExe.php" method="post" enctype="multipart/form-data">
        <div id="formulario">
        	<table width="763" border="0" >
              <tr>
                <td colspan="2" align="left" height="28"><strong>
                  <p>CADASTRO NOVO MAPA</p></strong></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td width="603" height="20">
                  <input name="endereco_mapa" type="text" size="50" />
                </td>
              </tr>
              <tr>
                ...
                <input type="file" name="icone" id="fileField2" /></td>
              </tr>
              <tr>
                ...
                <td height="20">
                  ...
                  <input type="file" name="img_mapa" id="fileField" /></td>
              </tr>
               <tr>
                ...
                <td height="20">
                  ...
                  <textarea name="texto_mapa" id="textarea2" cols="45" rows="5"></textarea></td>
              </tr>
              <tr>
                <td colspan="2" height="10"></td>
              </tr>
