...
<body id="adm">
	<div id="corpo">
    <p><a href="novo_LazerEntretenimento.php?categoria=<?php echo $_GET['pagina'];?>">Cadastrar novo<br> Lazer e Entretenimento</a></p>
    <?php    		
		...
		foreach ($listaCategoria as $categoria)
		{
			...
			echo'<tr>
					...
					<td width="68" bgcolor="'.$bgcolor.'"><a href="editar_LazerEntretenimento.php?id='.$categoria->getIdCategoria().'&categoria='.$_GET['pagina'].'"class="editar">EDITAR</a></td>
