...
<body id="adm">
	<div id="corpo">
    <p><a href="novo_Artesanato.php?categoria=<?php echo $_GET['pagina'];?>">Cadastrar novo Artesanato</a></p>
    <?php    		
		...
		foreach ($listaCategoria as $categoria)
		{
			...
			echo'<tr>
					...
					<td width="68" bgcolor="'.$bgcolor.'"><a href="editar_Artesanato.php?id='.$categoria->getIdCategoria().'&categoria='.$_GET['pagina'].'"class="editar">EDITAR</a></td>
