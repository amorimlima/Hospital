...
<body id="adm">
	<div id="corpo">
    <p><a href="novo_OndeCompra.php?categoria=<?php echo $_GET['pagina'];?>">Cadastrar novo <br>Local de Compra</a></p>
    <?php    		
		...
		foreach ($listaCategoria as $categoria)
		{
			...
			echo'<tr>
					...
					<td width="68" bgcolor="'.$bgcolor.'"><a href="editar_OndeCompra.php?id='.$categoria->getIdCategoria().'&categoria='.$_GET['pagina'].'"class="editar">EDITAR</a></td>
