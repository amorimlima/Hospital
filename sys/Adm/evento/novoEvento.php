...
<body id="adm">
	...
	<div id="corpo">
 		<form action="doAddEventoExe.php" method="post">
        <div id="formulario">
        	<table width="899" border="0" >
              <tr>
                <td colspan="2" align="left" height="28"><strong><p>CADASTRO EVENTO</p></strong></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td width="798" height="20">
                  <input name="tituloEvento" type="text" size="50" />
                </td>
              </tr>
              <tr>
                <td height="20" align="right"><strong>Data: </strong></td>
                <td height="20">
                  <input type="text" name="dataEvento" id="textfield" size="50" />
                </td>
              </tr>
              <tr>
                <td height="20" align="right" valign="top"><strong>Texto:</strong></td>
                <td height="20">
                  <textarea name="textoEvento" cols="45" rows="5"  ></textarea></td>
              </tr>
              <tr>
                <td colspan="2" height="10"></td>
              </tr>
